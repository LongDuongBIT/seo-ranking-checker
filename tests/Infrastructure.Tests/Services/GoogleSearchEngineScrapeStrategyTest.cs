...
public class GoogleSearchEngineScrapeStrategyTest
{
    private IOptions<ScraperSettings> _settings;

    [Test]
    public async Task GoogleSearchEngineScrapeStrategy_GetSearchEngineScrapeStrategies_ShouldReturnRankingsSuccessfully()
    {
        // Arrange
        ...
        var searchEngineScrapeStrategy = new GoogleSearchEngineScrapeStrategy(_settings, webDriver);
    ...
    [Test]
    public async Task GoogleSearchEngineScrapeStrategy_GetSearchEngineScrapeStrategies_ShouldReturnEmptyRankings()
    {
        // Arrange
        var webDriver = Substitute.For<IWebDriver>();
        var searchResultsElement = Substitute.For<IWebElement>();
